                ...
                <div>
                    <div className={stylesCss["content"]}>
                        <div className={stylesCss["content-item"]}>
                            ...
                            <p className={stylesCss["content-item-content"]}>
                                Các thông tin thu thập thông qua website <Link href={"https://www.xosookvip.com"}>https://www.xosookvip.com</Link> sẽ giúp chúng tôi:
                            </p>
                            <p className={stylesCss["content-item-content"]}>
                            ...
                            <p className={stylesCss["content-item-content"]}>
                                - Website <Link href={"https://www.xosookvip.com"}>https://www.xosookvip.com</Link>&nbsp;thu thập và sử dụng thông tin cá nhân quý khách với mục đích phù hợp và hoàn toàn tuân thủ nội dung của “Chính sách bảo mật” này.
                            </p>
                            <p className={stylesCss["content-item-content"]}>
                            ...
                            <p className={stylesCss["content-item-content"]}>
                                - <Link href={"https://www.xosookvip.com"}>https://www.xosookvip.com</Link>&nbsp;dùng "Cookie" để giúp cá nhân hóa và nâng cao tối đa hiệu quả sử dụng thời gian trực tuyến của quý khách.
                            </p>
                            <p className={stylesCss["content-item-content"]}>
                            ...
                            <p className={stylesCss["content-item-content"]}>
                                - Một trong những mục đích của Cookie là cung cấp những tiện ích để tiết kiệm thời gian của quý khách khi truy cập tại website của chúng tôi hoặc viếng thăm website <Link href={"https://www.xosookvip.com"}>https://www.xosookvip.com</Link>&nbsp;lần nữa mà không cần đăng ký lại thông tin sẵn có.
                            </p>
                            <p className={stylesCss["content-item-content"]}>
