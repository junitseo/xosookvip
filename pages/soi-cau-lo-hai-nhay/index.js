                ...
                <div className={stylesCss["col-lg-12"]}>
                    <div className={stylesCss["panel-default"]}>
                        ...
                        <div className={stylesCss["container-bottom"]}>
                            ...
                            <div className={stylesCss["title-bar-box"]}>
                                <b>Có 38 cầu cũ</b> - là những cầu có chiều dài cầu vượt số ngày cầu chạy bạn nhập vào
                            </div>
                            <div>
                            ...
                            <div className={stylesCss["title-bar-box"]}>
                                <b>Có 322 cầu mới</b> - là những cầu có chiều dài cầu bằng số ngày cầu chạy bạn nhập vào
                            </div>
                            <div>
