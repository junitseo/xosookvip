...
import { getCheckTheLotteryTwice } from "../../stores/northernlotteryprediction";
...
const CheckTheLotteryTwice = (props) => {
    ...
    const handleCheckTheLotteryTwice = async () => {
        const params = {
            top_day: isToDate ? toDate : moment(toDate).format(dateFormat),
            number: number,
        }
        const data = await getCheckTheLotteryTwice(params);
        if (data) {
            loadDataTable(data);
        }
    }
                ...
                <div className={stylesCss["col-lg-12"]}>
                    <div className={stylesCss["panel-default"]}>
                        <div className={stylesCss["panel-heading"]}>
                            <h1>Soi cầu lô hai nháy chở lên</h1>
                        </div>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td colspan="2" align="center">
                                                        <br></br>
                                                        <input type="submit" name="sbtsubmit" value="Xem kết quả" className={stylesCss["btn-btn-default"]} onClick={() => handleCheckTheLotteryTwice()} />
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
...
export const getServerSideProps = async () => {
    ...
    const [
        ...
        getCheckTheLotteryTwice(params)
    ]);
...
export default CheckTheLotteryTwice;