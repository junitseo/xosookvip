...
const LotteryPredictionsForStraightCombinations = () => {

    return (
        <div className={stylesCss["page-wrapper"]}>
            <Meta title="Soi cầu lô Bạch thủ ghép xuôi" />
                    ...
                    <div className={stylesCss["panel-default"]}>
                        ...
                        <div className={stylesCss["container-bottom"]}>
                            ...
                            <div className={stylesCss["title-bar-box"]}>
                                <b>Bạn đang xem toàn bộ cầu có số ngày cầu chạy là 2 ngày</b>
                            ...
                            <div className={stylesCss["title-bar-box"]}>
                                <b>Có 55 cầu cũ</b> - là những cầu có chiều dài cầu vượt số ngày cầu chạy bạn nhập vào
                            </div>
                            <div>
                            ...
                            <div className={stylesCss["clb"]}></div>
                            <div className={stylesCss["title-bar-box"]}>
                                <b>Có 327 cầu mới</b> - là những cầu có chiều dài cầu bằng số ngày cầu chạy bạn nhập vào
                            </div>
                            <div>
